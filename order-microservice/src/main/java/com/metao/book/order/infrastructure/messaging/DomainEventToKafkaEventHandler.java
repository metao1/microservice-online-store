...
public class DomainEventToKafkaEventHandler implements DomainEventPublisher {
    ...
    public void publish(DomainEvent event) {
        try {
            switch (event) {
                case DomainOrderCreatedEvent domainOrderCreatedEvent -> publishOrderCreatedEvent(
    ...
    private void publishOrderCreatedEvent(DomainOrderCreatedEvent domainEvent) {
