...
public class PaymentApplicationService {
    ...
    public Optional<PaymentDTO> getPaymentByOrderId(String orderId) {
        ...
        return paymentRepository.findByOrderId(id).map(PaymentApplicationMapper::toDTO);
    }
    ...
    public PaymentDTO processPayment(String id) {
        ...
        log.info("Payment processed successfully: {} with status: {} ({} ms)", id, payment.getStatus(), elapsedMillis);
        return PaymentApplicationMapper.toDTO(payment);
    }
