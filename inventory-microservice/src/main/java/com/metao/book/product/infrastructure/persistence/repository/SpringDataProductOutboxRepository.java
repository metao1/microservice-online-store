...
public interface SpringDataProductOutboxRepository
    extends JpaRepository<ProductOutboxJpaEntity, String> {

    @Lock(LockModeType.PESSIMISTIC_WRITE)
    @Query("""
        select event
        from ProductOutboxJpaEntity event
        ...
        """)
    List<ProductOutboxJpaEntity> findClaimable(
